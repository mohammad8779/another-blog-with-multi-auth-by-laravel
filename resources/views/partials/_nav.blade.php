                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="{{Request::is('posts')? "active":"" }}"><a href="/posts">Posts</a></li>
                         <li class="{{Request::is('categoies')? "active":"" }}"><a href="/categories">Categories</a></li>
                          <li class="{{Request::is('tags')? "active":"" }}"><a href="/tags">Tags</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        @if (Auth::check())
                        <li class="dropdown">
                            <a href="{{ url('/') }}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hello {{ Auth::user()->name }} <span class="caret"></span></a>
